...
public class WeeWoo {
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("add stuffies"); // makes the window
        frame.setLayout(new CardLayout()); // sets the layout (also makes the text box centered for some reason)
        ...
        JButton button = new JButton("ADD"); // button that say weewoo
